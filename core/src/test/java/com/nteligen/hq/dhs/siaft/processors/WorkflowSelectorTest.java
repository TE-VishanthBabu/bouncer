...
public class WorkflowSelectorTest
{
  ...
  public void testBadUUIDJobId()
  {
    ...
    MockFlowFile result = results.get(0);
    result.assertAttributeEquals(SIAFTUtils.ENTRY, DynamicRouter.PIPELINE.getName());
  }
  ...
  public void testFileNoExtension()
  {
    ...
    testEntrySetTestFile(testFile, DynamicRouter.PIPELINE.getName());
  }
  ...
  public void testFileMasquerading()
  {
    ...
    //                      DynamicRouter.PIPELINE.getName());
